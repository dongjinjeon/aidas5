...
define('G5_MYSQL_USER', 'aidas');
define('G5_MYSQL_PASSWORD', 'As12!@12886886');
define('G5_MYSQL_DB', 'aidas_main');
define('G5_MYSQL_SET_MODE', true);

define('G5_TABLE_PREFIX', 'g5_');

define('G5_TOKEN_ENCRYPTION_KEY', '16ebe9a039030d4077377f326329ae0a'); // 토큰 암호화에 사용할 키

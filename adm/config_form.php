        ...
        <div class="tbl_frm01 tbl_wrap">
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        <th scope="row"><label for="cf_bank">입금계좌</label></th>
                        <td colspan="3">
                            <input type="text" name="cf_bank" value="<?php echo $config['cf_bank']; ?>" id="cf_bank" class="frm_input" size="52">
                        </td>
                    </tr>
        ...
        <div class="tbl_frm01 tbl_wrap">
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        <th scope="row"><label for="cf_collection">개인정보 수집ㆍ이용</label></th>
                        <td colspan="3"><textarea id="cf_collection" name="cf_collection" rows="10"><?php echo html_purifier($config['cf_collection']); ?></textarea></td>
                    </tr>
                </tbody>
            </table>
        </div>
